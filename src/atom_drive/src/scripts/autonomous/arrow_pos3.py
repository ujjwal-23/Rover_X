...
net = cv2.dnn.readNet('/home/ujjwal/scripts/arrow_detection_harshill/yolov3.cfg', '/home/ujjwal/scripts/arrow_detection_harshill/yolov3_best.weights')

classes = []
with open("/home/ujjwal/scripts/arrow_detection_harshill/new_weights/arrow.names", "r") as f:
