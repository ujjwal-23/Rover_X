...
right_cascade = cv2.CascadeClassifier("/home/ujjwal/scripts/rpi-car-arrow-detection-using-cascade-classifier-master/haar_trained_xml/right/cascade.xml")
left_cascade = cv2.CascadeClassifier("/home/ujjwal/scripts/rpi-car-arrow-detection-using-cascade-classifier-master/haar_trained_xml/left/cascade.xml")
